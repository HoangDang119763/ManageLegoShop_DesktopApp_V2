...
// tblSupplier.setItems(FXCollections.observableArrayList(SupplierBUS.getInstance().filterSuppliers("",
// "", 1)));
...
// txtSearchSupplier.textProperty().addListener((observable, oldValue, newValue)
// -> handleSearch());
// }
...
// if (btnExitGetSupplier.getScene() != null &&
// btnExitGetSupplier.getScene().getWindow() != null) {
