...
// private Tab tab2;
// @FXML
// private TableView<DTO.StatisticDTO.QuarterlyEmployeeRevenue>
// tblEmployeeRevenue;
// @FXML
// private TableColumn<DTO.StatisticDTO.QuarterlyEmployeeRevenue, Integer>
// tbl_col_id;
// @FXML
// private TableColumn<DTO.StatisticDTO.QuarterlyEmployeeRevenue, String>
// tbl_col_quy1;
// @FXML
// private TableColumn<DTO.StatisticDTO.QuarterlyEmployeeRevenue, String>
// tbl_col_quy2;
...
// private ArrayList<StatisticDTO.ProductRevenue> productRevenuesList = new
// ArrayList<>();
// private ArrayList<DTO.StatisticDTO.QuarterlyEmployeeRevenue>
// employeeRevenueList = new ArrayList<>();
...
// tbl_col_productid.setCellValueFactory(new
// PropertyValueFactory<>("productId"));
// tbl_col_productname.setCellValueFactory(new
// PropertyValueFactory<>("productName"));
// tbl_col_productcate.setCellValueFactory(new
// PropertyValueFactory<>("categoryName"));
// tbl_col_totalquantity.setCellValueFactory(new
// PropertyValueFactory<>("totalQuantity"));
...
// try {
// if (txtStartCreateDate.getValue() == null || txtEndCreateDate.getValue() ==
// null) {
...
// throw new IllegalArgumentException("Ngày bắt đầu phải trước hoặc bằng ngày
// kết thúc.");
// }

// ArrayList<ProductRevenue> list =
// StatisticBUS.getInstance().getProductRevenue(start, end);
...
// } catch (Exception e) {
// NotificationUtils.showErrorAlert("Lỗi tải dữ liệu: " + e.getMessage(),
// "Lỗi");
// }
// }
...
// ArrayList<QuarterlyEmployeeRevenue> list =
// StatisticBUS.getInstance().getQuarterlyEmployeeRevenue(year);
...
// NotificationUtils.showInfoAlert("Không có dữ liệu để xuất cho Doanh thu Sản
// phẩm", "Thông báo");
// return;
// } else if (tab2.isSelected() && employeeRevenueList.isEmpty()) {
// NotificationUtils.showInfoAlert("Không có dữ liệu để xuất cho Doanh thu Nhân
// Viên", "Thông báo");
// return;
// }
...
// if (tab1.isSelected()) {
// ExcelService.getInstance().exportToFileExcelProductRevenues(productRevenuesList,
// timestamp,start, end);
// } else if (tab2.isSelected()) {
// ExcelService.getInstance().exportToFileExcelEmployeeRevenues(employeeRevenueList,
// timestamp, year);
// }
// }
