...
// CustomerModalController modalController =
...
// NotificationUtils.showErrorAlert("Bạn không thể xóa khách hàng vãng lai.",
// "Thông báo");
// return;
// }
...
// resetFilters();
// }
// case 2 -> NotificationUtils.showErrorAlert("Có lỗi khi xóa khách hàng. Vui
// lòng thử lại.", "Thông báo");
// case 3 -> NotificationUtils.showErrorAlert("Bạn không thể xóa khách hàng vãng
// lai.", "Thông báo");
// case 4 -> NotificationUtils.showErrorAlert("Bạn không có quyền xóa khách
// hàng", "Thông báo");
// case 5 -> NotificationUtils.showErrorAlert("Khách hàng không tồn tại hoặc đã
// bị xóa", "Thông báo");
// case 6 -> NotificationUtils.showErrorAlert("Xoá khách hàng thất bại. Vui lòng
// thử lại.", "Thông báo");
// default -> NotificationUtils.showErrorAlert("Lỗi không xác định", "Thông
// báo");
// }
// }
