...
// new
// SimpleStringProperty(cateBUS.getByIdLocal(cellData.getValue().getCategoryId()).getName())
// );
// tlb_col_sellingPrice.setCellValueFactory(cellData -> new
// SimpleStringProperty(ValidationUtils.getInstance().formatCurrency(cellData.getValue().getSellingPrice())));
// tlb_col_stockQuantity.setCellValueFactory(new
...
// handlePriceChange());
// txtEndPrice.textProperty().addListener((observable, oldValue, newValue) ->
// handlePriceChange());
...
// statusFilter, startPrice, endPrice)
// ));
...
// if
// (ProductBUS.getInstance().getByIdLocal(selectedProduct.getId()).getStockQuantity()
// != 0) {
// NotificationUtils.showErrorAlert("Sản sản phẩm còn hàng tồn, không thể xóa!",
// "Thông báo");
// return;
// }

// if (!UiUtils.gI().showConfirmAlert("Bạn chắc muốn xóa sản phẩm này?", "Thông
// báo xác nhận")) return;

// int deleteResult =
// ProductBUS.getInstance().delete(selectedProduct.getId(),SessionManagerService.getInstance().employeeRoleId(),
...
// }
// case 2 ->
// NotificationUtils.showErrorAlert("Có lỗi khi xóa sản phẩm. Vui lòng thử
// lại.", "Thông báo");
// case 3 ->
// NotificationUtils.showErrorAlert("Bạn không có quyền \"Xóa sản phẩm\" để thực
// hiện thao tác này.", "Thông báo");
// case 4 ->
// NotificationUtils.showErrorAlert("Xóa sản phẩm thất bại. Vui lòng thử lại
// sau.", "Thông báo");
// case 5 ->
// NotificationUtils.showErrorAlert("Sản sản phẩm còn hàng tồn, không thể xóa!",
// "Thông báo");
...
// ProductModalController modalController =
