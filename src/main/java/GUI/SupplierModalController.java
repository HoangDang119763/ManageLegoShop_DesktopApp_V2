...
// @FXML
// public ComboBox<String> cbSelectStatus;
...
// statusBus.getByTypeLocal(StatusType.SUPPLIER);
...
// txtSupplierId.setText(String.valueOf(SupplierBUS.getInstance().getAllLocal().size()
// + 1));
// } else {
// if (supplier == null)
// handleClose();
...
// cbSelectStatus.getSelectionModel().select(supplier.isStatus() ? "Hoạt động" :
// "Ngưng hoạt động");
// }
// }
...
// if (name.isEmpty()) {
// NotificationUtils.showErrorAlert("Tên nhà cung cấp không được để trống.",
// "Thông báo");
// clearAndFocus(txtCompanyName);
// isValid = false;
// } else if (!validator.validateVietnameseText100(name)) {
// NotificationUtils.showErrorAlert("Tên nhà cung cấp không hợp lệ (tối đa 100
// ký tự).", "Thông báo");
// clearAndFocus(txtCompanyName);
// isValid = false;
// }
...
// NotificationUtils.showErrorAlert("Số điện thoại không được để trống.", "Thông
// báo");
// clearAndFocus(txtPhone);
// isValid = false;
// } else if (isValid && !validator.validateVietnamesePhoneNumber(phone)) {
// NotificationUtils.showErrorAlert("Số điện thoại không hợp lệ(Số 0 đứng đầu và
// theo sau 9 ký tự)",
// "Thông báo");
// clearAndFocus(txtPhone);
// isValid = false;
...
// NotificationUtils.showErrorAlert("Địa chỉ không được để trống.", "Thông
// báo");
// clearAndFocus(txtAddress);
// isValid = false;
// } else if (isValid && !validator.validateVietnameseText255(address)) {
// NotificationUtils.showErrorAlert("Địa chỉ không hợp lệ (tối đa 255 ký tự)",
// "Thông báo");
// isValid = false;
// }
// return isValid;
...
// int insertResult = supplierBus.insert(temp,
...
// }
// case 2 ->
// NotificationUtils.showErrorAlert("Có lỗi khi thêm nhà cung cấp. Vui lòng thử
// lại.", "Thông báo");
// case 3 -> NotificationUtils.showErrorAlert("Đã có nhà cung cấp trong cơ sở dữ
// liệu", "Thông báo");
// case 4 -> NotificationUtils.showErrorAlert("Không có quyền thêm nhà cung
// cấp.", "Thông báo");
// case 5 -> NotificationUtils.showErrorAlert("Thêm nhà cung cấp vào CSDL thất
// bại. Vui lòng thử lại.",
// "Thông báo");
// case 6 -> NotificationUtils.showErrorAlert("Dữ liệu nhập không hợp lệ.",
// "Thông báo");
...
// SupplierBUS supplierBus = SupplierBUS.getInstance();
// if (isValidInput()) {
// SupplierDTO temp = new SupplierDTO(supplier.getId(),
// txtCompanyName.getText().trim(),
// txtPhone.getText().trim(), txtAddress.getText().trim(),
// txtEmail.getText().trim(),
// cbSelectStatus.getValue().equals("Hoạt động"));
// int updateResult = supplierBus.update(temp,
// SessionManagerService.getInstance().employeeRoleId(),
// SessionManagerService.getInstance().employeeLoginId());
// switch (updateResult) {
// case 1 -> {
...
// handleClose();
// }
// case 2 -> NotificationUtils
// .showErrorAlert("Có lỗi khi cập nhật thông tin nhà cung cấp. Vui lòng thử
// lại", "Lỗi");
// case 3 -> NotificationUtils.showErrorAlert("Thông tin nhà cung cấp bị trùng
// lặp.", "Lỗi");
// case 4 ->
// NotificationUtils.showErrorAlert("Không có quyền cập nhật thông tin nhà cung
// cấp.", "Thông báo.");
// case 5 -> NotificationUtils
// .showErrorAlert("Không thể cập nhật thông tin nhà cung cấp. Vui lòng thử
// lại.", "Lỗi");
// case 6 -> NotificationUtils.showErrorAlert("Đầu vào không hợp lệ. Vui lòng
// thử lại.", "Thông báo");
// default -> NotificationUtils.showErrorAlert("Lỗi không xác định. Vui lòng thử
// lại.", "Lỗi");
// }
