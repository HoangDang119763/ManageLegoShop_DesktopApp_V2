...
public class AccountModalController {
    ...
    private void loadComboBox() {
        // ComboBox empợi và không có ComboBox nào cần load
    }
    ...
    private boolean isValidInput() {
        ...
        if (isValid && username.isEmpty()) {
            ...
            NotificationUtils.showErrorAlert(
                    "Tên tài khoản không hợp lệ (tối thiểu 4 ký tự, tối đa 50 ký tự, chỉ chữ và số).", "Thông báo");
            clearAndFocus(txtUsername);
            isValid = false;
        }
        ...
        if (isValid && password.isEmpty()) {
            ...
            NotificationUtils.showErrorAlert("Mật khẩu không hợp lệ (tối thiểu 6 ký tự, tối đa 255 ký tự).",
                    "Thông báo");
            clearAndFocus(txtPassword);
            isValid = false;
        }
