...
// @FXML
// private Button btnExitImportingForm, btnImportListProductEdit,
// btnSearchProduct, btnImportListProductClear, btnImportListProductRemove,
// btnSubmitImport, btnGetSupInfo;
// @FXML
...
// private ArrayList<TempDetailImportDTO> arrTempDetailImport = new
// ArrayList<>();
...
// if (ImportBUS.getInstance().isLocalEmpty())
// ImportBUS.getInstance().loadLocal();
...
// ProductBUS.getInstance().filterProducts("", "", -1, 1, null,null), 140);
...
// new
// SimpleStringProperty(validationUtils.formatCurrency(cellData.getValue().getSellingPrice())));
// tlb_col_totalPrice.setCellValueFactory(cellData ->
// new
// SimpleStringProperty(validationUtils.formatCurrency(cellData.getValue().getTotalPrice())));
...
// btnExitImportingForm.setOnMouseClicked(event ->
// onMouseClickedExitImportingForm());
// btnSearchProduct.setOnMouseClicked(event -> onMousedClickSearchProduct());
// btnGetSupInfo.setOnMouseClicked(event ->
// onMouseClickedShowSupplierContainer());
...
// phẩm", txtProductNameSearch.getText(), -1, 1, null, null);
// clearGrid(gpShowProductWrapper);
// if (list.isEmpty()) {
// return;
// }
...
// SupForImportModalController modalController =
...
// NotificationUtils.showInfoAlert("Chọn nhà cung cấp thành công.", "Thông
// báo");
// }
// }
...
// image, String name, String categoryName, int quantity, BigDecimal price,
// String id) {
// // ImageView
...
// NotificationUtils.showErrorAlert("Vui lòng chọn chi tiết phiếu nhập.", "Thông
// báo");
// return;
// }

// ImportProductModalController modalController =
// UiUtils.gI().openStageWithController(
...
// NotificationUtils.showInfoAlert("Sửa chi tiết phiếu nhập thành công.", "Thông
// báo");
// }
// }
...
// NotificationUtils.showInfoAlert("Xóa chi tiết phiếu nhập thành công.", "Thông
// báo");
// }
...
// }
// lbTotalImportPrice.setText(ValidationUtils.getInstance().formatCurrency(totalImportPrice)
// + " Đ");
// }
...
// changeLabelContent();
// loadTable();
// NotificationUtils.showInfoAlert("Xóa toàn bộ chi tiết phiếu nhập thành
// công.", "Thông báo");
...
// private void addEventClickForProduct(TableView<TempDetailImportDTO>
...
// loadCaculatedTotalImportPrice();
// loadTable();
// NotificationUtils.showInfoAlert("Thêm chi tiết phiếu nhập thành công.",
// "Thông báo");
// }
// }
...
// selectedTempDetailImport =
// tbvDetailImportProduct.getSelectionModel().getSelectedItem();
...
// NotificationUtils.showErrorAlert("Vui lòng thêm ít nhất một sản phẩm nhập.",
// "Thông báo");
// return;
// }
// if (isNotSelectedSupplier()) {
// NotificationUtils.showErrorAlert("Vui lòng chọn nhà cung cấp để nhập hàng.",
// "Thông báo");
// return;
// }
...
// DetailImportDTO di = new DetailImportDTO(t.getImportId(), t.getProductId(),
// t.getQuantity(), t.getPrice(), t.getTotalPrice());
// ProductDTO p = new ProductDTO(t.getProductId(), t.getName(), t.getQuantity()
// , t.getSellingPrice(), true, null, null, 0);
// list.add(di);
// listProduct.add(p);
// totalImportPrice = totalImportPrice.add(t.getTotalPrice());
// }
// ImportDTO temp = new
// ImportDTO(Integer.parseInt(txtImportId.getText().trim()), null,
// Integer.parseInt(txtEmployeeId.getText().trim()),
// Integer.parseInt(txtSupplierId.getText().trim()), totalImportPrice);
// String extra = "Tổng tiền nhập: " +
// ValidationUtils.getInstance().formatCurrency(totalImportPrice) + " Đ";
// boolean submit = NotificationUtils.showConfirmAlert("Xác nhận phiếu nhập",
// arrTempDetailImport, "Thông Báo", extra);
// // khong xac nhan khong nhap

// if (!submit) return;

// boolean result =
// ImportService.getInstance().createImportWithDetailImport(temp,
// ses.employeeRoleId(),list , ses.employeeLoginId());
