...
// txtDescription.setText(role.getDescription() == null ? "" :
// role.getDescription());
...
// if (roleName.isEmpty()) {
// NotificationUtils.showErrorAlert("Tên chức vụ không được để trống.", "Thông
// báo");
// clearAndFocus(txtRoleName);
// isValid = false;
// } else if (!validator.validateVietnameseText50(roleName)) {
// NotificationUtils.showErrorAlert("Tên chức vụ không hợp lệ (tối đa 50 ký tự,
// không chứa ký tự đặc biệt).", "Thông báo");
// clearAndFocus(txtRoleName);
// isValid = false;
// }

// // Kiểm tra hệ số lương
// if (isValid && salaryCoefficientText.isEmpty()) { // Chỉ kiểm tra hệ số lương
// nếu tên chức vụ hợp lệ
...
// NotificationUtils.showErrorAlert("Hệ số lương không hợp lệ (tối đa 5 chữ số,
// 2 số thập phân, không âm hoặc bằng 0).", "Thông báo");
// clearAndFocus(txtSalaryCoefficient);
// isValid = false;
// }
...
// !validator.validateVietnameseText255(description)) {
// NotificationUtils.showErrorAlert("Mô tả không hợp lệ (tối đa 255 ký tự, không
// chứa ký tự đặc biệt).", "Thông báo");
...
// RolePermissionService.getInstance();
// if (isValidInput()) {

// RoleDTO temp = new RoleDTO(0, txtRoleName.getText().trim(),
// txtDescription.getText().trim(), new
// BigDecimal(txtSalaryCoefficient.getText().trim()));
// int insertResult = rolePermissionService.createRoleWithPermissions(temp,
...
// handleClose();
// }
// case 2 -> NotificationUtils.showErrorAlert("Có lỗi khi thêm chức vụ. Vui lòng
// thử lại.", "Thông báo");
// case 3 ->
// NotificationUtils.showErrorAlert("Bạn không có quyền \"Thêm chức vụ\" để thực
// hiện thao tác này.", "Thông báo");
// case 4 -> {
// NotificationUtils.showErrorAlert("Tên chức vụ đã tồn tại trong hệ thống.",
// "Thông báo");
// clearAndFocus(txtRoleName);
// }
// case 5 -> NotificationUtils.showErrorAlert("Thêm chức vụ thất bại. Vui lòng
...
// if (isValidInput()) {
// RoleDTO temp = new RoleDTO(role.getId(), txtRoleName.getText().trim(),
// txtDescription.getText().trim() , new
// BigDecimal(txtSalaryCoefficient.getText().trim()));
// int updateResult = rBus.update(temp,
// SessionManagerService.getInstance().employeeRoleId(),
// SessionManagerService.getInstance().employeeLoginId());
// switch (updateResult) {
// case 1 -> {
...
// handleClose();
// }
// case 2 -> NotificationUtils.showErrorAlert("Có lỗi khi cập nhật chức vụ. Vui
// lòng thử lại.", "Thông báo");
// case 3 ->
// NotificationUtils.showErrorAlert("Bạn không có quyền \"Cập nhật chức vụ\" để
// thực hiện thao tác này.", "Thông báo");
...
// case 7 -> NotificationUtils.showErrorAlert("Cập nhật chức vụ thất bại. Vui
// lòng thử lại sau.", "Thông báo");
// default -> NotificationUtils.showErrorAlert("Lỗi không xác định, vui lòng thử
// lại sau.", "Thông báo");
// }
// }
