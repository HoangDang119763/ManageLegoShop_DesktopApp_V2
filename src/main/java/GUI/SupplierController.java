...
public class SupplierController implements IController {
    ...
    public void loadTable() {
        ...
        tlb_col_status.setCellValueFactory(
                cellData -> formatCell(cellData.getValue().isStatus() ? "Hoạt động" : "Ngưng hoạt động"));
    ...
    private void handleDeleteBtn() {
        ...
        switch (deleteResult) {
            ...
            case 2 -> NotificationUtils.showErrorAlert("Lỗi xoá nhà cung cấp không thành công. Vui lòng thử lại",
                    "Thông báo");
