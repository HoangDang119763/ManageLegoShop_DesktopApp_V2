...
// txtCategoryId.setText(String.valueOf(CategoryBUS.getInstance().getAllLocal().size()
// + 1));
// } else {
...
// cbSelectStatus.getSelectionModel().select(category.isStatus() ? "Hoạt động" :
// "Ngưng hoạt động");
// }
// }
...
// NotificationUtils.showErrorAlert("Tên thể loại không được để trống", "Thông
// báo");
...
// NotificationUtils.showErrorAlert("Tên không hợp lệ (1-50 ký tự, a-z, A-Z,
// 0-9.)", "Thông báo");
// clearAndFocus(txtCategoryName);
// isValid = false;
// }
...
// handleClose();
// }
// case 2 -> NotificationUtils.showErrorAlert("Dữ liệu không hợp lệ. Vui lòng
// kiểm tra lại.", "Thông báo");
// case 3 -> NotificationUtils.showErrorAlert("Thể loại bị trùng lặp. Không thể
// thêm.", "Thông báo");
// case 4 -> NotificationUtils.showErrorAlert("Không có quyền thêm thể loại.",
// "Thông báo");
// case 5 -> NotificationUtils.showErrorAlert("Lỗi kết nối CSDL. Thêm thể loại
// thất bại.", "Thông báo");
// default -> NotificationUtils.showErrorAlert("Lỗi không xác định. Thêm thể
// loại thất bại.", "Thông báo");
// }
// }
// }
...
// case 3 -> NotificationUtils.showErrorAlert("Thể loại bị trùng lặp. Không thể
// cập nhật.", "Thông báo");
// case 4 -> NotificationUtils.showErrorAlert("Không có quyền sửa thể loại.",
// "Thông báo");
// case 5 -> NotificationUtils.showErrorAlert("Không thể cập nhật thể loại.",
// "Thông báo");
// case 6 -> NotificationUtils.showErrorAlert("Không thể cập nhật thể loại
// gốc!", "Thông báo");
// default -> NotificationUtils.showErrorAlert("Lỗi không xác định. Cập nhật thể
// loại thất bại.", "Thông báo");
// }
// }
// }
