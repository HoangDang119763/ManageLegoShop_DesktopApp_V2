...
// tlb_col_firstName.setCellValueFactory(new
...
// return new SimpleStringProperty(role != null && role.getName() != null ?
// role.getName() : "");
// });
...
// formatCell(validationUtils.formatCurrency(calculateFinalSalary(cellData.getValue(),
// roleBUS))));
...
// cbSearchBy.getSelectionModel().selectFirst(); // Ch�+�n gi+� tr�+� -�ߦ�u
// ti+�n
...
// private BigDecimal calculateFinalSalary(EmployeeDTO employee, RoleBUS
// roleBUS) {
...
// EmployeeModalController modalController =
...
// {
// NotificationUtils.showErrorAlert("Không thể xóa nhân viên gốc.", "Thông
// báo");
// return;
// }

// int deleteResult =
// EmployeeBUS.getInstance().delete(selectedEmployee.getId(),SessionManagerService.getInstance().employeeRoleId(),
// SessionManagerService.getInstance().employeeLoginId());
...
// }
// case 2 ->
// NotificationUtils.showErrorAlert("Có lỗi khi xóa nhân viên. Vui lòng thử
// lại.", "Thông báo");
// case 3 ->
// NotificationUtils.showErrorAlert("Bạn không thể xóa thông tin của chính
// mình.", "Thông báo");
// case 4 ->
// NotificationUtils.showErrorAlert("Bạn không có quyền \"Xóa nhân viên\" để
// thực hiện thao tác này.", "Thông báo");
// case 5 ->
// NotificationUtils.showErrorAlert("Bạn không thể xóa nhân viên ngang quyền.",
// "Thông báo");
// case 6 ->
// NotificationUtils.showErrorAlert("Xóa nhân viên thất bại. Vui lòng thử lại.",
// "Thông báo");
// case 7 ->
...
// báo");
// default ->
// NotificationUtils.showErrorAlert("Lỗi không xác định. Vui lòng thử lại.",
// "Thông báo");
// }
// }
...
// }
// if(selectedEmployee.getId() == 1 &&
// SessionManagerService.getInstance().employeeLoginId() != 1)
// {
// NotificationUtils.showErrorAlert("Không thể sửa nhân viên gốc.", "Thông
// báo");
// return;
// }
// EmployeeModalController modalController =
