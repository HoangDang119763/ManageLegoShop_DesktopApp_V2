...
public class InvoiceService {
    ...
    public boolean createInvoiceWithDetailInvoice(InvoiceDTO invoice, int employee_roleId,
            ArrayList<DetailInvoiceDTO> list, int eployeeLoginId) {
    ...
    // public boolean deleteInvoiceWithDetailInvoice(int invoiceId, int
    // employee_roleId, int eployeeLoginId) {
    // InvoiceBUS invBus = InvoiceBUS.getInstance();
    // DetailInvoiceBUS dinvBus = DetailInvoiceBUS.getInstance();
    //
    ...
    // ArrayList<DetailInvoiceDTO> tempList =
    // dinvBus.getAllDetailInvoiceByInvoiceIdLocal(invoiceId);
    //
    // if (!dinvBus.delete(invoiceId, employee_roleId,
    // ServiceAccessCode.INVOICE_DETAILINVOICE_SERVICE, eployeeLoginId)) {
    // System.err.println("Failed to delete detail invoice. Attempting to roll back
    // invoice.");
    // // Thêm lại Invoice
    ...
    // ServiceAccessCode.INVOICE_DETAILINVOICE_SERVICE, eployeeLoginId);
    // } else {
    // System.err.println("Rollback successful, but no detail invoices to
    // restore.");
    // }
    // } else {
