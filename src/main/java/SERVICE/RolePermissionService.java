...
public class RolePermissionService {
    ...
    public int createRoleWithPermissions(RoleDTO role, int employee_roleId, int employeeLoginId) {
        ...
        // roleBus.loadLocal();
        // int resultr = roleBus.insert(role, employee_roleId,
        // ServiceAccessCode.ROLE_PERMISSION_SERVICE,
        // employeeLoginId);
        // if (resultr != 1) {
    ...
    public int deleteRoleWithPermissions(int roleId, int employee_roleId, int employeeLoginId) {
        ...
        // if (rolePermissionBus.isLocalEmpty())
        // rolePermissionBus.loadLocal();
        // ArrayList<RolePermissionDTO> tempList =
        // rolePermissionBus.getAllRolePermissionByRoleIdLocal(roleId);

        // // Xóa role_permission trước
        // if (!RoleBUS.getInstance().isValidRole(roleId)) {
        // return roleBus.delete(roleId, employee_roleId,
        // ServiceAccessCode.ROLE_PERMISSION_SERVICE,
        // employeeLoginId) ? 1 : 2;
        // }
        ...
        // ServiceAccessCode.ROLE_PERMISSION_SERVICE,
        // employeeLoginId)) {
        // System.err.println("Failed to delete role. Attempting to roll back role
        // permissions.");
