...
CREATE TABLE `employee` (
  ...
  `health_ins_code` varchar(50) COLLATE utf8mb4_bin DEFAULT '0',
...
(
  ...
  `health_ins_code`, `social_insurance_code`, `unemployment_insurance_code`, 
  `is_personal_income_tax`, `is_transportation_support`, `is_accommodation_support`
) 
VALUES 
-- Tài khoản hệ thống
('ID', 'ADMIN', '', 'admin@company.com', NULL, 1, NULL, 1, 'Nam', 1, 'HI-000000', 'SI-000000', 'UI-000000', 1, 1, 1),

-- Ban lãnh đạo (Dept 1)
('Đặng Huy', 'Hoàng', '0123456789', 'hoang.dh@company.com', '2004-06-11', 2, 1, 1, 'Nam', 2, 'HI-2026001', 'SI-2026001', 'UI-2026001', 1, 1, 1),
('Vũ Thị', 'Iến', '0900123456', 'ien.vt@company.com', '1994-09-25', 2, 1, 1, 'Nữ', 3, 'HI-2026011', 'SI-2026011', 'UI-2026011', 1, 1, 1),
('Lý Văn', 'Nam', '0911234567', 'nam.lv@company.com', '1996-10-30', 2, 1, 1, 'Nam', 4, 'HI-2026012', 'SI-2026012', 'UI-2026012', 1, 0, 0),

-- Nhân sự & Quản lý (Dept 2)
('Nguyễn Thành', 'Long', '0987654321', 'long.nt@company.com', '2003-04-11', 3, 2, 1, 'Nam', 5, 'HI-2026002', 'SI-2026002', 'UI-2026002', 1, 0, 0),
('Trịnh Văn', 'Hùng', '0999012345', 'hung.tv@company.com', '1989-08-20', 3, 2, 2, 'Nam', 6, 'HI-2026010', 'SI-2026010', 'UI-2026010', 1, 0, 0),

-- Kinh doanh (Dept 3)
('Tần Thiên', 'Lang', '0912345678', 'lang.tt@company.com', '2000-01-15', 4, 3, 1, 'Nam', 7, 'HI-2026003', 'SI-2026003', 'UI-2026003', 0, 1, 0),
('Lê Thị', 'Bích', '0933456789', 'bich.lt@company.com', '1988-02-20', 3, 4, 1, 'Nữ', 8, 'HI-2026004', '0', 'UI-2026004', 1, 0, 1),
('Phạm Minh', 'Chính', '0944567890', 'chinh.pm@company.com', '1985-03-25', 4, 3, 1, 'Nam', 9, 'HI-2026005', 'SI-2026005', '0', 1, 1, 1),
('Nguyễn Thị', 'Diệu', '0955678901', 'dieu.nt@company.com', '1992-04-30', 4, 3, 1, 'Nữ', 10, 'HI-2026006', '0', '0', 1, 0, 0),
('Ngô Minh', 'Giàu', '0988901234', 'giau.nm@company.com', '1991-07-15', 6, 3, 1, 'Nam', 11, 'HI-2026009', 'SI-2026009', 'UI-2026009', 0, 1, 1),
('Bùi Thị', 'Phượng', '0977890123', 'phuong.bt@company.com', '1993-06-10', 6, 3, 1, 'Nữ', 12, 'HI-2026008', 'SI-2026008', 'UI-2026008', 1, 1, 0),

-- Kho vận (Dept 4)
('Đỗ Văn', 'Em', '0966789012', 'em.dv@company.com', '1995-05-05', 7, 4, 1, 'Nam', 13, 'HI-2026007', 'SI-2026007', 'UI-2026007', 0, 0, 0);
...
INSERT INTO `leave_type` (`id`,`type`,`fine_amount`) VALUES
(1,'Nghỉ có phép',500000.00);
...
INSERT INTO `leave_request` (
  `id`, `leave_type_id`, `content`, `start_date`, `end_date`, `status_id`, `employee_id`
) VALUES
  (1, 1, 'Về quê ăn giỗ','2026-02-10', '2026-02-12', 22, 1),
  (2, 1, 'Sốt xuất huyết','2026-02-01', '2026-02-05', 20, 2),
  (3, 1, 'Đi đám cưới bạn thân','2026-02-15', '2026-02-15', 22, 3),
  (4, 1, 'Nghỉ sinh con theo chế độ','2026-03-01', '2026-09-01', 22, 4),
  (5, 1, 'Đi du lịch Đà Lạt','2026-02-20', '2026-02-25', 22, 5),
  (6, 1, 'Giải quyết việc gia đình','2026-02-03', '2026-02-04', 22, 6);
...
UPDATE employment_history SET status_id = (SELECT id FROM status WHERE type = 'EMPLOYMENT_HISTORY' AND name = 'Canceled' LIMIT 1);
